-- =====================================================
-- RESET BÁSICO DO BANCO DE DADOS
...
-- =====================================================
-- PASSO 2: DELETAR DADOS DAS TABELAS PRINCIPAIS
-- =====================================================

-- Deletar dados em ordem de dependência usando blocos seguros
DO $$
BEGIN
    -- Primeiro: Dados dependentes
    BEGIN
        TRUNCATE TABLE public.game_players CASCADE;
        RAISE NOTICE '✅ game_players: dados deletados';
    EXCEPTION
    ...
    BEGIN
        ...
        RAISE NOTICE '✅ game_sessions: dados deletados';
    EXCEPTION
        WHEN undefined_table THEN
    ...
    BEGIN
        TRUNCATE TABLE public.participation_requests CASCADE;
        RAISE NOTICE '✅ participation_requests: dados deletados';
    EXCEPTION
        WHEN undefined_table THEN
    ...
    BEGIN
        ...
        RAISE NOTICE '✅ players: dados deletados';
    EXCEPTION
        WHEN undefined_table THEN
    ...
    BEGIN
        ...
        RAISE NOTICE '✅ games: dados deletados';
    EXCEPTION
        WHEN undefined_table THEN
    ...
    BEGIN
        ...
        RAISE NOTICE '✅ users: dados deletados';
    EXCEPTION
        WHEN undefined_table THEN
