-- =====================================================
-- RECRIAR TABELAS PRINCIPAIS DO SISTEMA (VERSÃO CORRIGIDA)
...
-- =====================================================
-- 7. CRIAR ÍNDICES PARA PERFORMANCE (COM VERIFICAÇÃO)
-- =====================================================

-- Função para criar índices com verificação de existência da tabela
DO $$
BEGIN
    -- Índices para users
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
        ...
        RAISE NOTICE '✅ Índices para users criados';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'players') THEN
        ...
        RAISE NOTICE '✅ Índices para players criados';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'games') THEN
        ...
        RAISE NOTICE '✅ Índices para games criados';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_players') THEN
        ...
        RAISE NOTICE '✅ Índices para game_players criados';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_sessions') THEN
        ...
        RAISE NOTICE '✅ Índices para game_sessions criados';
    END IF;

    -- Índices para participation_requests
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'participation_requests') THEN
        ...
        RAISE NOTICE '✅ Índices para participation_requests criados';
    END IF;
END $$;
...
-- Habilitar RLS em todas as tabelas (com verificação)
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
        ALTER TABLE public.users ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '✅ RLS habilitado para users';
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'players') THEN
        ALTER TABLE public.players ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '✅ RLS habilitado para players';
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'games') THEN
        ALTER TABLE public.games ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '✅ RLS habilitado para games';
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_players') THEN
        ALTER TABLE public.game_players ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '✅ RLS habilitado para game_players';
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_sessions') THEN
        ALTER TABLE public.game_sessions ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '✅ RLS habilitado para game_sessions';
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'participation_requests') THEN
        ALTER TABLE public.participation_requests ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '✅ RLS habilitado para participation_requests';
    END IF;
END $$;
...
-- Triggers para atualizar updated_at (com verificação)
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
        ...
        RAISE NOTICE '✅ Trigger para users criado';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'players') THEN
        ...
        CREATE TRIGGER update_players_updated_at
            ...
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();
        RAISE NOTICE '✅ Trigger para players criado';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'games') THEN
        ...
        CREATE TRIGGER update_games_updated_at
            ...
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();
        RAISE NOTICE '✅ Trigger para games criado';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_players') THEN
        ...
        CREATE TRIGGER update_game_players_updated_at
            ...
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();
        RAISE NOTICE '✅ Trigger para game_players criado';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'game_sessions') THEN
        ...
        CREATE TRIGGER update_game_sessions_updated_at
            ...
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();
        RAISE NOTICE '✅ Trigger para game_sessions criado';
    END IF;
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'participation_requests') THEN
        ...
        CREATE TRIGGER update_participation_requests_updated_at
            ...
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();
        RAISE NOTICE '✅ Trigger para participation_requests criado';
    END IF;
END $$;
