-- =====================================================
-- CORRIGIR INCONSISTÊNCIAS DE TELEFONE
-- Sistema: VaiDarJogo Flutter
-- =====================================================
-- 
-- OBJETIVO: Corrigir inconsistências entre users.phone e players.phone_number
-- 
-- ⚠️  IMPORTANTE: 
-- 1. Execute apenas se houver inconsistências
-- 2. Prioriza dados da tabela players
-- 3. Não afeta dados consistentes
-- =====================================================
...
UNION ALL
SELECT 
    'Telefones consistentes' as categoria,
    COUNT(*) as quantidade
FROM public.users u
JOIN public.players p ON u.id = p.user_id
